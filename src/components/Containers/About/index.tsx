            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="md:pt-8">
                ...
                <p className="sm:text-lg mb-6 md:mb-8 text-justify">
                  <span className="bg-gray-200 dark:bg-gray-800 p-1 rounded font-mono">
                ...
                <p className="sm:text-lg mb-6 md:mb-8 text-justify">
                  ...
                  <span className="bg-gray-200 dark:bg-gray-800 text-[15px] p-1 rounded font-mono">
                    npx degit nuflakbrr/frontend-template#nextjs-ts nama-proyek
                  </span>
                </p>
