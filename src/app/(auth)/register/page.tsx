...
export const metadata = genPageMetadata({
  ...
  description: 'Buat akun BikinProject dan mulai bangun project Anda dengan lebih cepat dan efisien.',
});
      ...
      <div className="w-full max-w-md bg-white dark:bg-zinc-950 rounded-3xl border-2 border-zinc-100 dark:border-zinc-800 shadow-2xl overflow-hidden">
        <div className="bg-zinc-50 dark:bg-zinc-900/50 px-6 py-4 border-b-2 border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono font-bold text-zinc-900 dark:text-white">auth --register</span>
          </div>
        ...
        <div className="p-8 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 font-medium">Bergabung dengan komunitas BikinProject.</p>
          </div>
